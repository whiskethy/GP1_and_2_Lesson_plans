...
2024, v4.01. Source: ISTE (International Society for Technology in Education), [iste.org/standards](https://iste.org/standards). Reformatted for reference and MkDocs Material linking; wording preserved from source, only OCR/layout artifacts cleaned up.

## Contents

- [Students](#students)
    - [1.1 Empowered Learner](#11-empowered-learner)
    - [1.2 Digital Citizen](#12-digital-citizen)
    - [1.3 Knowledge Constructor](#13-knowledge-constructor)
    - [1.4 Innovative Designer](#14-innovative-designer)
    - [1.5 Computational Thinker](#15-computational-thinker)
    - [1.6 Creative Communicator](#16-creative-communicator)
    - [1.7 Global Collaborator](#17-global-collaborator)
- [Educators](#educators)
    - [2.1 Learner](#21-learner)
    - [2.2 Leader](#22-leader)
    - [2.3 Citizen](#23-citizen)
    - [2.4 Collaborator](#24-collaborator)
    - [2.5 Designer](#25-designer)
    - [2.6 Facilitator](#26-facilitator)
    - [2.7 Analyst](#27-analyst)
- [Education Leaders](#education-leaders)
    - [3.1 Equity and Citizenship Advocate](#31-equity-and-citizenship-advocate)
    - [3.2 Visionary Planner](#32-visionary-planner)
    - [3.3 Empowering Leader](#33-empowering-leader)
    - [3.4 Systems Designer](#34-systems-designer)
    - [3.5 Connected Learner](#35-connected-learner)
- [Coaches](#coaches)
    - [4.1 Change Agent](#41-change-agent)
    - [4.2 Connected Learner](#42-connected-learner)
    - [4.3 Collaborator](#43-collaborator)
    - [4.4 Learning Designer](#44-learning-designer)
    - [4.5 Professional Learning Facilitator](#45-professional-learning-facilitator)
    - [4.6 Data-Driven Decision-Maker](#46-data-driven-decision-maker)
    - [4.7 Digital Citizen Advocate](#47-digital-citizen-advocate)
- [Adopting the ISTE Standards](#adopting-the-iste-standards)
...
Take action to protect their digital privacy on devices and manage their personal data and security while online.
...
*Empowered Professional* — *Learning Catalyst*

> [!note] Source note
> Both subtitles above appear in the source PDF for this section (the first under the section header, the second partway through, ahead of the Collaborator standard). It's unclear whether ISTE intends two role-framings for Educators or this is a layout artifact from the PDF extraction — worth a quick check against the official ISTE page if it matters for how you cite this.
...
Educators seek opportunities for leadership to support student empowerment and success and to improve teaching and learning. Educators:
...
Teachers inspire students to positively contribute and responsibly participate in the digital world. Educators:
...
Teachers dedicate time to collaborate with both colleagues and students to improve practice, discover and share resources and ideas, and solve problems. Educators:
...
Teachers design authentic, learner-driven activities and environments that recognize and accommodate learner variability. Educators:
...
Teachers facilitate learning with technology to support student achievement of the 2016 ISTE Standards for Students. Educators:
...
Teachers understand and use data to drive their instruction and support students in achieving their learning goals. Educators:
...
*Source citation from this section: Crompton, H. (2023). Evidence of the ISTE Standards for Educators leading to learning gains.* Journal of Digital Learning in Teacher Education, *39(4), 201–219. https://doi.org/10.1080/21532974.2023.2244089*
...
Collaborate with educators, leaders and students to foster inclusive online spaces and healthy balance in their use of technology.
...
The ISTE Standards are research-based and can meet local goals, needs and priorities. Adopting the standards in a school, district, state/province or nation takes different forms. Leaders may decide to use the standards in a variety of ways, including:
...
**References cited in the source document**
