...
day_type: C
chunk: '11'
type: new idea (functions) + practice
class_minutes: 72
unit: 1
status: active
updated: 2026-09-13
...
- **Engagement:** C-day (72 min) gives time for both new content and practice
- **Representation:** Live coding demo of functions on screen; syntax reference sheet available
- **Action & Expression:** Working programs committed to GitHub
- **Accommodations:** Practice programs have starter code for students who need it
